...
from CSV_Updater_Functions import process_csv_data
...
class CSVUpdaterGUI(QWidget):
    def __init__(self):
        ...
        self.file_path = "" # The file to be updated
        self.init_ui()
    ...
    def select_excel_file(self):
        ...
        #   Only allow user to select .csv files
        #   Check if all inputs have been collected.
        #
        file_dialog = QFileDialog()
        file_path, _ = file_dialog.getOpenFileName(self, "Select Excel File", "", "CSV Files (*.csv)")
        if file_path:
    ...
    def run_processing(self):
        ...
        process_csv_data(self.file_path)

        # self.output_console.append(f"\nFunction 2 Output:\n{output2}") # Indenting Function Output Messages
        self.output_console.append("")
        self.output_console.append("Final Status: SUCCESS") # Success Messag
